...
urlpatterns = [
    ...
    path('user/group/manage', manage_groups_view, name='manage_groups'),
    path('user/group/create', create_group_view, name='create_group'),
    path('user/group/<int:id>/delete', delete_group_view, name='delete_group'),
    path('user/group/<int:id>', edit_group_view, name='edit_group'),
