...
urlpatterns = [
    ...
    path('attachment/<int:id>/<str:name>', attachment_access_control, name='attachment'),
    path('attachment/upload', upload_attachment_view, name="upload_attachment"),
    #path('attachment/upload/ticket/<int:id>', ticket_upload_attachment_view, name="ticket_upload_attachment"),
    #path('attachment/upload/comment/<int:id>', comment_upload_attachment_view, name="comment_upload_attachment"),
