...
urlpatterns = [
    ...
    path('category/manage', manage_categories_view, name="manage_categories"),
    path('category/<int:id>', edit_category_view, name="edit_category"),
    path('category/<int:id>/delete', delete_category_view, name="delete_category"),
